class RussianDebries extends Debris {

  RussianDebries(int number, String name, int item, String launchDate, String epochDate, String epochTime, float sma, float eccentricity, float inclination, float raan, float perigee, float true_anomaly, float period, float perigee_altitude, float apogee_altitude, String country, String purpose, String  status  ) {
